        ...
        return(
            <View style={{ flex:1 }}>
                <View style={{position:"absolute" , top:0 }}>
                    <Image style={{width:win.width , height:  362 * ratio}} source={{'uri' : data.mainImage}} />
                </View>
                <Header noShadow style={{backgroundColor:"transparent",paddingTop:20 , position:"absolute" , top : 0 ,  zIndex:1000}}>
                    <Left>
                    ...
                    <View style={{zIndex:-1 ,  backgroundColor:"white"}}>
                        <View style={{marginHorizontal:20 ,flexDirection:"column"}}>
                            <View style={{flexDirection:"row" , marginTop:15}}>    
                                <View style={{flex:3}}>
                                    <Thumbnail large square source={{'uri' : data.thumbnail}} />
                                </View>
                                <View style={{flex:6 , flexDirection : "column"}}>
                                    <H3>{data.name}</H3>
                                    <Text style={{color:"#888" }}>.. company</Text>
                                    <Text style={{borderWidth:2,lineHeight:25 , height:25,width:25 , fontWeight:"bold" , textAlign:"center"}}>3+</Text>
                                    <Text style={{color:"#888"}}>{ data.size }</Text>
                                </View>
                            ...
                            <View style={{flexDirection:"row" , justifyContent:"flex-end"}}> 
                                <Button style={{backgroundColor:"#43a047" , height:30 , lineHeight:30 ,  borderRadius:5}} onPress={()=> this.fo()}><Text style={{paddingHorizontal:30 ,paddingVertical:10, color:"white"}}> INSTAL </Text></Button>
                            </View>
                            }
                            ...
                            <View style={{ padding:20}}>
                                <Text style={{textAlign:"justify" ,  fontSize:16 , wordSpacing:8}}>
                                    {data.description}
                                </Text>
                            </View>   
                            ...
                            <View style={{ marginTop:20,flexDirection:"row" , alignItems:"center" , minHeight:90  }}>
                                ...
                                <View style={{flex:1 }}>
                                    <H3 style={{fontSize:50 , flex:1 , lineHeight:90}}>{data.rating}</H3>
                                </View>
